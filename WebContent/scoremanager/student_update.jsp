              ...
              <form action = "StudentUpdateExecute.action" method="post">
                 <div class="mx-3 py-2">
                      <div class="mb-3">
                          ...
                          <input readonly class="form-control-plaintext ms-3" type="text" id="student-ent_year-input" name="ent_year" value="${ent_year}" />
                      </div>
                      <div class="mb-3">
                          <label class="form-label" for="student-no-input">学生番号</label>
                          <input readonly class="form-control-plaintext ms-3" type="text" id="student-no-input" name="no" value="${no}" />
                      </div>
                      <div class="mb-3">
                          <label class="form-label" for="student-name-input">氏名</label>
                          <input class="form-control" type="text" id="student-name-input" name="name" value="${name}" required />
                      ...
                      <div class="mb-3">
                          ...
                          <input class="form-check-input" type="checkbox" id="student-attend-check" name="is_attend"<c:if test="${is_attend}">checked</c:if>>
                      </div>
                      <div class="mt-3">
